...
//vaylb added
String8 VirtualDisplaySurface::getConsumerName(){
    return mDisplayName;
}

void VirtualDisplaySurface::setVideoHookFlag(int flag){
	
}

void VirtualDisplaySurface::setSlaveIp(String16 ip){

}

void VirtualDisplaySurface::setScreenSplit(bool split){

}

void VirtualDisplaySurface::setSlaveIpNum(int num){
