...
public:
    ...
    //vaylb added 
    virtual String8 getConsumerName() = 0;
	virtual void setVideoHookFlag(int flag) = 0;
	virtual void setSlaveIp(String16 ip) = 0;
	virtual void setScreenSplit(bool split) = 0;
	virtual void setSlaveIpNum(int num) = 0;
};
