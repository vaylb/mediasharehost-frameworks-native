...
public:
	...
	//vaylb added
	virtual status_t setVideoHook(bool flag) = 0;
	virtual status_t initVideoShareClient() = 0;
	virtual status_t setSlaveIp(String16 ip) = 0;
	virtual status_t setScreenSplit(bool split) = 0;
	//added fot middleware
	virtual status_t setSlaveNum(int num) = 0;
};
